...
namespace Emrys.SSO.Common
{
    ...
    /// 自定义Session实现方式
    /// </summary>
    public class SSOSessionStateStoreProvider : SessionStateStoreProviderBase
    {
        private readonly SessionsDB db = new SessionsDB();
        ...
        /// 是否是passport主网站
        /// </summary>
        public virtual bool IsPassport
        {
            get
            {
                return false;
        ...
        /// </summary>
        static SSOSessionStateStoreProvider()
        {
